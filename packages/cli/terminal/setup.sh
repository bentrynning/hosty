...
get_package() {
    ...
    info "Downloading engine package from release of Hosty engine ..."
    curl -L "https://github.com/bentrynning/hosty/releases/latest/download/engine-latest.tar.gz" -o "$1" ||
